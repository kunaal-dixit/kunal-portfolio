...
export const siteConfig = {
  ...
  bio: "I'm a software engineer working at the intersection of Salesforce and event-driven data systems — Apex, LWC, Integrations and all salesforce solutions on one side; Kafka, Flink, Spark, Databricks and AWS on the other. I build platforms that move tens of millions of records a day, ship managed packages and AppExchange apps, and mentor teams on clean architecture and DevOps. I design and build solutions that are scalable, efficient and maintainable using Agentic AI and LLMs.",
